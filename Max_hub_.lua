...
_G.Color = Color3.fromRGB(80, 245, 245) ---Color

local Star = StarHub:Window(" ")

local StarServer = Star:Server("Dang Dz Steal",8521503225) --ใส่idรูปได้
...
elseif ThreeWorld then
	...
	Tp:Button("Bigmom Island", function()
	...
	Tp:Button("Raid", function()
		TP2(CFrame.new(-5057.146484375, 314.54132080078, -2934.7995605469))
	end)
end

local Raid = StarServer:Channel("DangDungeonLab")
...
if _G.Noclip == false then
	...
	Misc:Toggle("Dang DZ", true, function(vu)
		_G.BoostFPS = vu
	end)
